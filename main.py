...
if __name__=="__main__":
    ...
    ###调整batchsize=64；32；32
    parser.add_argument("--batch_size", type=int, default=64)
    parser.add_argument("--lr", type=float, default=0.001)
    parser.add_argument("--n_epochs", type=int, default=30)###一开始epoch=40，训练后发现30开始收敛，改
    parser.add_argument("--trainset", type=str, default="./CCKS_2019_Task1/preprocessed_data/train_dataset.txt")
    parser.add_argument("--validset", type=str, default="./CCKS_2019_Task1/preprocessed_data/val_dataset.txt")
    parser.add_argument("--testset", type=str, default="./CCKS_2019_Task1/preprocessed_data/test_dataset.txt")
